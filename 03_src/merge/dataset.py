...
def fusion_donnees_externes(data):
    ...
    data_code_insee = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/code_insee_24.parquet")
    ...
    data_population_insee = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/population_24.parquet")
    ...
    data_revenu_insee = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/revenu_median_24.parquet")
    ...
    data_delinquance = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/delinquance_24.parquet")
    ...
    data_urban = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/info_urbaines_24.parquet").
                  astype({"CODGEO":"string"}))
    ...
    data_statut_tourisme = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/statut_touristique_24.parquet")
    ...
    data_infra_tourisme = (pd.read_parquet(f"{chemin_repo}/01_data/01_raw/infrastructures_tourisme_24.parquet")
    ...
    data_bpe = con.sql(f"""
        ...
        FROM read_parquet('{chemin_repo}/01_data/01_raw/bpe_24.parquet')
    ...
    if results.success == True:
        data.to_csv(f"{chemin_repo}/01_data/02_processed/01_merge/housing_open_data_processed.csv", index = False)
